...
O SGBD que estou utilizando nesse projeto é o [PostgreSQL](https://www.postgresql.org/) instalado em um servidor Linux e para a criação do banco e suas respectivas tabelas, estou utilizado a ferramenta [Pg Admin 4](https://www.pgadmin.org/download/pgadmin-4-windows/).
